  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result?.error) {
        ...
        toast.success("Welcome to EchoForge!")
    ...
    <main className="min-h-screen bg-gradient-to-b from-[#0b1020] to-[#1a1f3a] flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-white/60">Join thousands using cutting-edge AI detection</p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-white/40">
          🔒 Secure signup • Founded by Peters Princewill
        </p>
      </div>
    </main>
  )
